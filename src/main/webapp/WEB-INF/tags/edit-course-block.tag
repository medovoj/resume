...
<%@ attribute name="course" required="false" type="com.medovoy.resume.entity.Course"%>

<div id="ui-item-${index }" class="card">
	<div class="card-body ">
		<div class="row">
			<div class="col-xs-12">
				<button type="button" class="btn-close float-end" onclick="$('#ui-item-${index }').remove();"></button>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6 col-md-4 form-group ${hasError ? 'has-error has-feedback' : ''}">
				<label class="control-label" for="items${index }name">Course name</label>
			...
			<div class="col-xs-6 col-md-4 form-group ${hasError ? 'has-error has-feedback' : ''}">
				<label class="control-label" for="items${index }school">Name of school, academy</label>
			...
			<div class="col-xs-12 col-md-4 form-group">
				<label for="items${index }finishDate">End date</label>
				<div class="row">
					<div class="col-xs-6">
